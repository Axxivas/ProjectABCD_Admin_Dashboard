...
from DolphinCode import text_field, text_field_Description, root, translate, language, sort_order, title_font_var, title_size_var, subtitle_font_var, subtitle_size_var,text_size_label,text_font_var, text_size_var, pic_width_var, pic_height_var, layout, numbering, download_imgs, book_gen_generate_button, gen_local,diff_report_button, download_google_imgs, google_image_search_button, word_analysis_button,wiki_link_gen_button
import traceback
